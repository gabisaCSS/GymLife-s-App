...
class EditTrainingComponent extends StatelessWidget {
  const EditTrainingComponent({super.key});
              ...
              onPressed: isAllEnabled
                  ? () {
                      ...
                      context
                          ...
                          .editTraining(trainingModel: trainingModel);

                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text('Exercise Succesfuly Edited!')));
                    }
                  : null,

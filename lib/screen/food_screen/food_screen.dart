...
import 'package:gym_lifes_app/screen/food_screen/component/recipe_ingr_field_component.dart';
import 'package:gym_lifes_app/screen/food_screen/component/recipe_title_field_component.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              'Energi    : ${nutrisi.enercKcal.quantity} ${nutrisi.enercKcal.unit}'),
                          Text(
                              'Carbs    : ${nutrisi.carb.quantity} ${nutrisi.carb.unit}'),
                          Text(
                              'Protein  : ${nutrisi.protein.quantity} ${nutrisi.protein.unit}'),
                          Text(
                              'Fat         : ${nutrisi.fat.quantity} ${nutrisi.fat.unit}'),
                          Text(
                              'Fiber      : ${nutrisi.fiber.quantity} ${nutrisi.fiber.unit}'),
                          Text(
                              'Sugar       : ${nutrisi.sugar.quantity} ${nutrisi.sugar.unit}'),
                        ]),
                  ),
                );
